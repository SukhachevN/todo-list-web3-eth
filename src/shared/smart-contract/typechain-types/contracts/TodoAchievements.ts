...
export interface TodoAchievementsInterface extends utils.Interface {
  functions: {
...
export interface TodoAchievements extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TodoAchievementsInterface;
